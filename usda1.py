...
""" This program accesses the public USDA database of foods, searches 
    for a particular food and delivers the nutritional information.  
    We need to refine the search to return more useful information, 
    more refined.  Also needed, add error handling, return a health 
    score by comparing the protein, carbs, calories and other nutrients
    to rate each food on how good it is for you.  """
